...
pub fn glium_renderering() -> Vec<Box<dyn ApplicationBundleBuilder>> {
    vec!(
        Box::new(zoml_builder()),
        Box::new(glium_renderer_builder()),
    )
}

fn glium_renderer_builder() -> GliumRendererBuilder {
